...
const skills = {
  ...
  meteor: { id: "meteor", name: "陨星术", type: "magic", cost: 10, power: 1.95, effect: "damage", poiseDamage: 5, breakBonusDamageRatio: 0.52, bonusVsChargingRatio: 0.22, description: "高消耗高爆发，对蓄力或失衡目标更致命。", resourceCost: 4, inspectTags: ["法师", "终结", "高耗", "窗口爆发"] },
  ...
  aimed_shot: { id: "aimed_shot", name: "瞄准射击", type: "physical", cost: 3, power: 1.4, effect: "damage", poiseDamage: 4, delayTarget: 8, bonusVsChargingRatio: 0.2, description: "游侠的精准输出，对蓄力敌人可形成有效压制。", resourceGain: 1, inspectTags: ["游侠", "单点", "压制"] },
  ...
  piercing_shot: { id: "piercing_shot", name: "贯心矢", type: "physical", cost: 6, power: 1.6, effect: "damage", poiseDamage: 5, delayTarget: 8, breakBonusDamageRatio: 0.44, bonusVsBrokenRatio: 0.2, resourceCost: 2, description: "鹰眼专精的精确处决，对失衡目标具备极强收尾能力。", inspectTags: ["游侠", "专精", "狙击", "处决"] },
  ...
  shadow_flurry: { id: "shadow_flurry", name: "影袭乱舞", type: "physical", cost: 9, power: 2.0, effect: "damage", advanceSelf: 10, breakBonusDamageRatio: 0.38, bonusVsBrokenRatio: 0.16, description: "盗贼爆发核心，适合顺着失衡窗口连击收尾。", resourceCost: 4, inspectTags: ["盗贼", "连击终结", "处决"] },
  ambush: { id: "ambush", name: "潜袭处决", type: "physical", cost: 6, power: 1.7, effect: "damage", advanceSelf: 14, breakBonusDamageRatio: 0.3, bonusFirst: 0.2, bonusVsChargingRatio: 0.14, bonusVsBrokenRatio: 0.16, resourceCost: 2, description: "暗刃专精的抢节奏技能，擅长扑向蓄力破绽与处决窗口。", inspectTags: ["盗贼", "专精", "斩杀", "抢轴"] },
  ...
  execution_seal: { id: "execution_seal", name: "处决印记", type: "magic", cost: 8, power: 1.85, effect: "damage", poiseDamage: 6, breakBonusDamageRatio: 0.58, bonusVsBrokenRatio: 0.24, description: "高压单体爆发，对失衡目标会形成真正的处决打击。", resourceCost: 4, inspectTags: ["圣骑士", "处决", "失衡收尾"] },
  verdict_blade: { id: "verdict_blade", name: "圣誓裁刃", type: "physical", cost: 7, power: 1.6, effect: "damage", poiseDamage: 7, breakBonusDamageRatio: 0.65, bonusVsChargingRatio: 0.18, bonusVsBrokenRatio: 0.28, resourceCost: 3, description: "圣罚专精的高压处决，对蓄力与失衡目标都有更强压制力。", inspectTags: ["圣骑士", "专精", "终结", "处决"] },
